...
router.get("/properties", authenticate, isLandOfficer, getPropertyStats);
...
// @access  Admin, Land Officer
router.get("/documents", authenticate, isLandOfficer, getDocumentStats);

// @route   GET /api/reports/payments
// @desc    Get payment statistics
// @access  Admin, Land Officer
router.get("/payments", authenticate, isLandOfficer, getPaymentStats);

// @route   GET /api/reports/applications
// @desc    Generate application statistics report
// @access  Admin, Land Officer
router.get("/applications", authenticate, isLandOfficer, generateApplicationReport);
...
// @access  Admin, Land Officer
router.get("/activity", authenticate, isLandOfficer, getActivityLogs);
